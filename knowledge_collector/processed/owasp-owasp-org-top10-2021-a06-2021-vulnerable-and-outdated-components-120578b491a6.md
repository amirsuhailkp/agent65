...
- vulnerabilities
- use
date_collected: '2026-07-25T14:25:38.202024Z'
language: unknown
---
...
- Only obtain components from official sources over secure links. Prefer signed packages to reduce the chance of including a modified, malicious component (see

  [A08:2021-Software and Data Integrity Failures](../A08_2021-Software_and_Data_Integrity_Failures/)).
