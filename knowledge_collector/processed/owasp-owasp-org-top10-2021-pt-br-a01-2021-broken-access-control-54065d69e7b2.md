---
title: A01:2021 – Quebra de Controle de Acesso
source: owasp.org
url: https://owasp.org/Top10/2021/pt-BR/A01_2021-Broken_Access_Control/
collector: owasp
...
- controle
- usu
date_collected: '2026-07-25T14:25:22.440670Z'
language: unknown
---
...
CWEs MapeadosTaxa de Incidência MáximaTaxa de Incidência MédiaExploração Média PonderadaImpacto Médio PonderadoCobertura MáximaCobertura MédiaTotal de ocorrênciasTotal de CVEs3455.97%3.81%6.925.9394.55%47.72%318,48719,013
...
com mais de 318 mil. Notável *Common Weakness Enumerations* (CWEs) incluídas são
...
- Manipulação de metadados, como reproduzir ou adulterar um token de controle de acesso
  ...
  *JSON Web Token*(JWT), um cookie ou campo oculto manipulado para elevar privilégios ou abusar da invalidação de JWT.
...
- Implemente mecanismos de controle de acesso uma vez e reutilize-os em todo o aplicativo, incluindo a minimização do uso de
...
- Desative a lista de diretórios do servidor da web e certifique-se de que os metadados do arquivo (por exemplo, o

  *.git*) e os arquivos de backup não estejam presentes nas raízes da web (*web roots*).
