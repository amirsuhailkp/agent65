...
- query
- injection
date_collected: '2026-07-26T12:36:48.736747Z'
language: unknown
---
...
This cheat sheet is a derivative work of the [SQL Injection Prevention Cheat Sheet](SQL_Injection_Prevention_Cheat_Sheet.html).

## Parameterized Query Examples[¶](#parameterized-query-examples)

SQL Injection is best prevented through the use of  [parameterized queries](SQL_Injection_Prevention_Cheat_Sheet.html). The following chart demonstrates, with real-world code samples, how to build parameterized queries in most of the common web languages. The purpose of these code samples is to demonstrate to the web developer how to avoid SQL Injection when building database queries within a web application.
...
#### Using Java built-in feature[¶](#using-java-built-in-feature)
```
```
...
#### Using Java with Hibernate[¶](#using-java-with-hibernate)
```
```
// HQL
...
#### Using Ruby with ActiveRecord[¶](#using-ruby-with-activerecord)
```
```
## Create
...
#### Using Ruby built-in feature[¶](#using-ruby-built-in-feature)
```
```
...
#### Using PHP with PHP Data Objects[¶](#using-php-with-php-data-objects)
```
```
...
#### Using Cold Fusion built-in feature[¶](#using-cold-fusion-built-in-feature)
```
```
...
#### Using PERL with Database Independent Interface[¶](#using-perl-with-database-independent-interface)
```
```
...
#### Using Rust with SQLx[¶](#using-rust-with-sqlx)
```
```
...
#### Oracle using PL/SQL[¶](#oracle-using-plsql)

##### Normal Stored Procedure[¶](#normal-stored-procedure)
...
##### Stored Procedure Using Bind Variables in SQL Run with EXECUTE[¶](#stored-procedure-using-bind-variables-in-sql-run-with-execute)
...
#### SQL Server using Transact-SQL[¶](#sql-server-using-transact-sql)
...
##### Stored Procedure Using Bind Variables in SQL Run with EXEC[¶](#stored-procedure-using-bind-variables-in-sql-run-with-exec)
