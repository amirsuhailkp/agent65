...
- applications
- organization
date_collected: '2026-07-26T12:36:38.189859Z'
language: unknown
---

# Legacy Application Management Cheat Sheet[¶](#legacy-application-management-cheat-sheet)
...
Authorization measures enforce rules around who can access a given resource and how they can establish access to that resource. Authorization is covered in significant depth in the [Authorization Cheat Sheet](Authorization_Cheat_Sheet.html).
...
## Continuous Monitoring and Incident Response[¶](#continuous-monitoring-and-incident-response)
