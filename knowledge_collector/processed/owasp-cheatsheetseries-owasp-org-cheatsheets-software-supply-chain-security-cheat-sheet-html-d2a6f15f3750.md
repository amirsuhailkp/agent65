...
- ssc
- build
date_collected: '2026-07-26T12:36:59.793918Z'
language: unknown
---
...
## Overview of Threat Landscape[¶](#overview-of-threat-landscape)
...
## Mitigations and Security Best Practices[¶](#mitigations-and-security-best-practices)
...
#### Implement Strong Access Control[¶](#implement-strong-access-control)
...
#### Leverage Security Automation[¶](#leverage-security-automation)
...
### Mitigating Source Code Threats[¶](#mitigating-source-code-threats)
...
#### Secure Config of Version Control Systems[¶](#secure-config-of-version-control-systems)
...
#### Secure Development Platform[¶](#secure-development-platform)
...
### Mitigating Dependency Threats[¶](#mitigating-dependency-threats)

Best practices and techniques related to secure use of dependencies are described below.

#### Assess Suppliers[¶](#assess-suppliers)
...
#### Understand and Monitor Software Dependencies[¶](#understand-and-monitor-software-dependencies)
...
#### Lockfile/Version Pinning[¶](#lockfileversion-pinning)
...
#### Harden Build Tools[¶](#harden-build-tools)
...
#### Enforce Code Signing[¶](#enforce-code-signing)
...
#### Use Private Artifact Repository[¶](#use-private-artifact-repository)
...
#### Use Source Control for Build Scripts and Config[¶](#use-source-control-for-build-scripts-and-config)
...
#### Verify Provenance/Ensure Sufficient Metadata is Generated[¶](#verify-provenanceensure-sufficient-metadata-is-generated)
...
#### Ephemeral, Isolated Builds[¶](#ephemeral-isolated-builds)
...
#### Limit use of Parameters[¶](#limit-use-of-parameters)
...
### Deployment and Runtime Threats[¶](#deployment-and-runtime-threats)
...
#### Scan Final Build Binary[¶](#scan-final-build-binary)
...
#### Monitor Deployed Software for Vulnerabilities[¶](#monitor-deployed-software-for-vulnerabilities)
...
- [Google Cloud Software Supply Chain Security: Safeguard Source](https://cloud.google.com/software-supply-chain-security/docs/safeguard-source)
- [Google Cloud Software Supply Chain Security: Attack Vectors](https://cloud.google.com/software-supply-chain-security/docs/attack-vectors)
- [SLSA 1.0: Threats](https://slsa.dev/spec/v1.0/threats)
...
- [SLSA 1.0: Requirements](https://slsa.dev/spec/v1.0/requirements#provenance-generation)
- [Google Cloud Security Supply Chain Security: Safeguard Builds](https://cloud.google.com/software-supply-chain-security/docs/safeguard-builds)
