...
title: Introducción
source: owasp.org
url: https://owasp.org/Top10/2021/es/
collector: owasp
...
- los
- datos
date_collected: '2026-07-25T14:25:56.455233Z'
language: unknown
---
...
- asciende desde la sexta posición en la edición anterior; el 90% de las aplicaciones se probaron para detectar algún tipo de configuración incorrecta, con una tasa de incidencia promedio del 4,5% y más de 208.000 casos de CWEs relacionadas con esta categoría de riesgo. Con mayor presencia de software altamente configurable, no es sorprendente ver qué esta categoría ascendiera. El[A05:2021 - Configuración de Seguridad Incorrecta](A05_2021-Security_Misconfiguration/)**A4:2017-Entidades Externas XML(XXE)**, ahora en esta edición, forma parte de esta categoría de riesgo.
