...
- rule
- services
date_collected: '2026-07-26T12:37:07.869414Z'
language: unknown
---

# Web Service Security Cheat Sheet[¶](#web-service-security-cheat-sheet)
...
**Rule**: Client Certificate Authentication using [Mutual-TLS](https://en.wikipedia.org/wiki/Transport_Layer_Security) is a common form of authentication that is recommended where appropriate. See: [Authentication Cheat Sheet](Authentication_Cheat_Sheet.html).
...
**Rule**: All the rules of output encoding applies as per [Cross Site Scripting Prevention Cheat Sheet](Cross_Site_Scripting_Prevention_Cheat_Sheet.html).
...
### Resources Limiting[¶](#resources-limiting)
...
### XML Denial of Service Protection[¶](#xml-denial-of-service-protection)
...
## Endpoint Security Profile[¶](#endpoint-security-profile)
