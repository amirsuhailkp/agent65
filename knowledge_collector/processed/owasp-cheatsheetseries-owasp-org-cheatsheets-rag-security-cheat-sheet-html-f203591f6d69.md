...
- access
- documents
date_collected: '2026-07-26T12:36:49.256357Z'
language: unknown
---

# Retrieval-Augmented Generation (RAG) Security Cheat Sheet[¶](#retrieval-augmented-generation-rag-security-cheat-sheet)
...
## Section 1: Document Poisoning[¶](#section-1-document-poisoning)
...
## Section 2: Embedding Manipulation[¶](#section-2-embedding-manipulation)
...
### Attack Vectors[¶](#attack-vectors_1)
...
### Embedding Privacy[¶](#embedding-privacy)
...
## Section 3: Context Window Attacks[¶](#section-3-context-window-attacks)
...
### Attack Vectors[¶](#attack-vectors_2)
...
## Section 4: Access Control Inheritance[¶](#section-4-access-control-inheritance)
...
### Attack Vectors[¶](#attack-vectors_3)
...
### Data Deletion and Retention[¶](#data-deletion-and-retention)
...
## Section 5: Source Attribution and Provenance[¶](#section-5-source-attribution-and-provenance)
...
## Section 6: Chunk Isolation[¶](#section-6-chunk-isolation)
...
## Section 7: Index Integrity[¶](#section-7-index-integrity)
...
## Section 8: Query Injection via Retrieval[¶](#section-8-query-injection-via-retrieval)
...
## Section 9: Output Validation and Enforcement[¶](#section-9-output-validation-and-enforcement)
...
## Section 10: Tool Invocation and Agent Safety[¶](#section-10-tool-invocation-and-agent-safety)
...
## Section 11: Caching Risks[¶](#section-11-caching-risks)
...
## Section 12: Monitoring and Incident Response[¶](#section-12-monitoring-and-incident-response)
...
## Section 13: Supply Chain Risk in Ingestion[¶](#section-13-supply-chain-risk-in-ingestion)
...
## Section 14: Fail-Closed Design[¶](#section-14-fail-closed-design)
...
### Fail-Closed Examples[¶](#fail-closed-examples)
