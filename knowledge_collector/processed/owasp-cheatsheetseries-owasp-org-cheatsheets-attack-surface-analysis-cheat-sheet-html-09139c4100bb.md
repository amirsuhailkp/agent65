...
- application
- system
date_collected: '2026-07-26T12:36:09.839082Z'
language: unknown
---

# Attack Surface Analysis Cheat Sheet[¶](#attack-surface-analysis-cheat-sheet)

## What is Attack Surface Analysis and Why is it Important[¶](#what-is-attack-surface-analysis-and-why-is-it-important)
...
## Defining the Attack Surface of an Application[¶](#defining-the-attack-surface-of-an-application)
...
### Microservice and Cloud Native Applications[¶](#microservice-and-cloud-native-applications)
...
## Identifying and Mapping the Attack Surface[¶](#identifying-and-mapping-the-attack-surface)
...
## Measuring and Assessing the Attack Surface[¶](#measuring-and-assessing-the-attack-surface)
