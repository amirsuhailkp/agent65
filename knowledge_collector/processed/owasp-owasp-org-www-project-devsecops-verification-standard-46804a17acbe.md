...
source: owasp.org
url: https://owasp.org/www-project-devsecops-verification-standard/
collector: owasp
...
- secure
- software
date_collected: '2026-07-26T12:45:23.381767Z'
language: unknown
---
...
- ⚠️
  ...
  **During Third-party Risk Asessments**
...
Try it live at  **dsovs.com**, or run it from the

[folder. Rate your maturity against every DSOVS control and generate a report; it runs entirely in your browser, so your answers are saved locally on your device and never leave it. You can export your results as JSON or print them to PDF.](assessment/)
```
assessment/
```

Building your own tooling? Every control is also published as machine-readable data: the [JSON API](/www-project-devsecops-verification-standard/dist/dsovs.json) is generated from the source-of-truth files under <data/controls/>.

## 💬 Connect with Us

[#project-devsecops-verification-standard](https://owasp.slack.com/messages/project-devsecops-verification-standard/details/)

[@theonejvo](https://www.linkedin.com/in/theonejvo/)(Jamieson Vincenti O'Reilly, Project Lead)

[@yudhiy](https://www.linkedin.com/in/yudhiy/)(Yudhi Yudhistira, Project Lead)
