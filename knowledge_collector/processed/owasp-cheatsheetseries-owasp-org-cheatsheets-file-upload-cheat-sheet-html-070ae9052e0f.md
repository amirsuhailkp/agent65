...
- upload
- user
date_collected: '2026-07-26T12:36:26.609020Z'
language: unknown
---

# File Upload Cheat Sheet[¶](#file-upload-cheat-sheet)
...
- Exploit vulnerabilities in the file parser or processing module (*e.g.*[ImageTrick Exploit](https://imagetragick.com/),[XXE](https://owasp.org/www-community/vulnerabilities/XML_External_Entity_%28XXE%29_Processing))
...
#### List Allowed Extensions[¶](#list-allowed-extensions)
...
### File Signature Validation[¶](#file-signature-validation)
...
- Store the files **inside the webroot**, and set them in write permissions only. - If read access is required, setting proper controls is a must (*e.g.*internal IP, authorized user, etc.)
