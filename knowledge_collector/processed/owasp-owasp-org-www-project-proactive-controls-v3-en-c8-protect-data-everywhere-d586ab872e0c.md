...
source: top10proactive.owasp.org
url: https://top10proactive.owasp.org/archive/2018/c8-protect-data-everywhere/
collector: owasp
...
- sensitive
- keys
date_collected: '2026-07-25T14:30:04.983215Z'
language: unknown
---
...
You are looking at the legacy 2018 version of the OWASP Top 10 Proactive Controls. You can find information about the same control within the [OWASP Top 10 Proactive Controls 2024](../../2024/) within [C2: Use Cryptography to Protect Data](../../2024/the-top-10/c2-crypto/)!
...
When an immutable datatype such as
```
string
```

is used to store secrets, secrets can remain plaintext in the memory for a long time.
Even if you try to nullify the string value, it still remains in the memory.
```
string
```

is an immutable type and cannot be changed. When you modify a string (try to overwrite it), a new copy of it is created.
