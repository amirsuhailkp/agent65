...
source: owasp.org
url: https://owasp.org/Top10/2021/tr/A10_2021-Server-Side_Request_Forgery_(SSRF)/
collector: owasp
...
- sald
- lar
date_collected: '2026-07-25T14:28:33.822117Z'
language: unknown
---
...
- “Varsayılan olarak reddet (deny by default)” firewall policy’leri veya network access control kuralları uygulayın; temel intranet trafiği dışındaki her şeyi engelleyin.
  *İpuçları:*
  \~ Firewall kuralları için uygulama bazlı sahiplik ve lifecycle oluşturun.
  \~ Firewall’larda kabul edilen*ve*engellenen tüm network akışlarını log’layın (bkz.[A09:2021-Security Logging and Monitoring Failures](../A09_2021-Security_Logging_and_Monitoring_Failures/)).
...
**Senaryo #2: Hassas veri sızıntısı** – Saldırganlar yerel dosyalara veya iç servislere erişerek
```
file:///etc/passwd
```
...
gibi hassas bilgileri elde edebilir.

**Senaryo #3: Cloud servislerinin metadata storage’ına erişim** – Çoğu cloud sağlayıcısında
```
http://169.254.169.254/
```

gibi metadata storage bulunur. Bir saldırgan, metadata’yı okuyarak hassas bilgiler elde edebilir.
