...
- rest
- restful
date_collected: '2026-07-26T12:36:49.689186Z'
language: unknown
---

# REST Assessment Cheat Sheet[¶](#rest-assessment-cheat-sheet)

## About RESTful Web Services[¶](#about-restful-web-services)
...
## Key relevant properties of RESTful web services[¶](#key-relevant-properties-of-restful-web-services)
...
- Use of HTTP methods (
  ...
  ) as the primary verb for the requested operation.
...
## How to pentest a RESTful web service[¶](#how-to-pentest-a-restful-web-service)
...
- Look for non-standard parameters:
  ...
  - Look for highly varying URL segments - a single URL segment that has many values may be parameter and not a physical directory.
    - For example if the URL
      ...
      repeats with hundreds of value for
...
- [REST Security Cheat Sheet](REST_Security_Cheat_Sheet.html)- the other side of this cheat sheet
