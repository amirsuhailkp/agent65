...
- object
- identifiers
date_collected: '2026-07-26T12:36:32.719259Z'
language: unknown
---
...
- An **object**such as an account, document, support ticket, transaction or partner profile.
- A **reference**to that object in the form of an ID, UUID, account number, token or slug.
...
## Identifier complexity[¶](#identifier-complexity)
...
## Verifying access controls[¶](#verifying-access-controls)
...
- Create objects owned by each user (documents, support tickets, invoices, etc.).
- Authenticate as User A and attempt to access User B's objects by modifying object references in requests.
- Verify that the application denies unauthorized access regardless of whether the object identifier is predictable or unguessable.
