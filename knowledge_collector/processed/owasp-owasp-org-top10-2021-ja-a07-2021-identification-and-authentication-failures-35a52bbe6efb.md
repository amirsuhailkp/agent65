---
title: A07:2021 – 識別と認証の失敗
source: owasp.org
url: https://owasp.org/Top10/2021/ja/A07_2021-Identification_and_Authentication_Failures/
collector: owasp
...
- password
- application
date_collected: '2026-07-25T14:28:00.215126Z'
language: unknown
---
...
対応する CWE 数最大発生率平均発生率加重平均（攻撃の難易度）加重平均（攻撃による影響）最大網羅率平均網羅率総発生数CVE 合計件数2214.84%2.55%7.406.5079.51%45.72%132,1953,897
...
- パスワードをデータストアに保存する際に、プレーンテキストのままで保存している、または暗号化して保存している。あるいはハッシュ化して保存していたとしても脆弱なハッシュ関数を利用している。（
