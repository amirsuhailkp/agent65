...
- owasp
- java
date_collected: '2026-07-26T12:44:56.381427Z'
language: unknown
---
...
must be implemented by any new special class, which is not part of the library, while
```
validate()
```

is intended to facilitate the customization of existing classes.
