---
title: A10:2021 – Falsificación de Solicitudes del Lado del Servidor SSRF
source: owasp.org
url: https://owasp.org/Top10/2021/es/A10_2021-Server-Side_Request_Forgery_(SSRF)/
collector: owasp
...
- ssrf
- del
date_collected: '2026-07-25T14:26:55.618629Z'
language: unknown
---
...
CWEs mapeadasTasa de incidencia máxTasa de incidencia promExplotabilidad ponderada promImpacto ponderado promCobertura máxCobertura promIncidencias totalesTotal CVEs12.72%2.72%8.286.7267.72%67.72%9,503385
...
- Haga cumplir las políticas de firewall "denegar por defecto" o las reglas de control de acceso a la red para bloquear todo el tráfico de la intranet excepto el esencial.
  ...
  *Consejos:*
  ...
  ~ Registre en logs todos los flujos de red aceptados y bloqueados en firewalls (consulte[A09: 2021-Fallas en el Registro y Monitoreo](../A09_2021-Security_Logging_and_Monitoring_Failures/)).
...
**Escenario #3:** Acceso al almacenamiento de metadatos de los servicios en la nube: la mayoría de los proveedores de la nube tienen almacenamiento de metadatos como
```
