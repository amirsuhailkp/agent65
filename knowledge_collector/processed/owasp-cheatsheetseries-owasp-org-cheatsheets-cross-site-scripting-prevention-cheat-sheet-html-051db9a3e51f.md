...
- data
- xss
date_collected: '2026-07-26T12:36:18.646865Z'
language: unknown
---
...
## XSS Defense Philosophy[¶](#xss-defense-philosophy)
...
### Output Encoding for “HTML Contexts”[¶](#output-encoding-for-html-contexts)
...
### Output Encoding for “HTML Attribute Contexts”[¶](#output-encoding-for-html-attribute-contexts)
...
methods because they will automatically HTML Attribute Encode. Those are **Safe Sinks** as long as the attribute name is hardcoded and innocuous, like
```
id
```
...
### Output Encoding for “JavaScript Contexts”[¶](#output-encoding-for-javascript-contexts)
...
### Output Encoding for “CSS Contexts”[¶](#output-encoding-for-css-contexts)
...
### Output Encoding for “URL Contexts”[¶](#output-encoding-for-url-contexts)
...
### Dangerous Contexts[¶](#dangerous-contexts)
...
- Trusted Types - On Chromium-based browsers, enable [Trusted Types](https://web.dev/articles/trusted-types)by adding
  ```
...
Sample Defense: [DOM based XSS Prevention Cheat Sheet](DOM_based_XSS_Prevention_Cheat_Sheet.html) |
...
format, including spaces, where **HH** represents the hexadecimal value of the character in Unicode. For example,
```
A
```
...
encoding format, where **XXXX** represents the hexadecimal Unicode code point. For example,
```
A
```
...
## Common Anti-patterns: Ineffective Approaches to Avoid[¶](#common-anti-patterns-ineffective-approaches-to-avoid)
...
### Sole Reliance on Content-Security-Policy (CSP) Headers[¶](#sole-reliance-on-content-security-policy-csp-headers)
...
### Reliance on HTTP Interceptors[¶](#reliance-on-http-interceptors)
