---
title: A01:2021 – تخطي صلاحيات الوصول
source: owasp.org
url: https://owasp.org/Top10/2021/ar/A01_2021-Broken_Access_Control/
collector: owasp
...
- sensitive
- api
date_collected: '2026-07-25T14:25:15.036607Z'
language: unknown
---
...
ربطها مع CWEsالحد الأقصى للحدوثمتوسط معدل الحدوثالتغطية القصوىمتوسط معدل التغطيةمتوسط استغلال الثغراتمتوسط التأثيرإجمالي التكرارإجمالي نقاط الضعف CVEs3455.97%3.81%94.55%47.72%6.925.93318,48719,013
...
- تجاوز إجراءات
  ...
  **التحقق من التحكم في الوصول**من خلال تعديل محدد فيURL، او تعديل الكائنات “objects” المرتبطة بالبرنامج داخل الذاكرة أو تعديل صفحة الـ HTML، أو ببساطة استخدام أداة هجوم مخصصة لمهاجمة API
