...
url: https://cheatsheetseries.owasp.org/cheatsheets/Multifactor_Authentication_Cheat_Sheet
collector: owasp
...
- users
- authentication
date_collected: '2026-07-26T12:37:17.507329Z'
language: unknown
---

# Multifactor Authentication Cheat Sheet[¶](#multifactor-authentication-cheat-sheet)
...
### One-Time Password (OTP) Handling and Storage[¶](#one-time-password-otp-handling-and-storage)
...
### Changing MFA Factors[¶](#changing-mfa-factors)
...
### Consider Using a Third Party Service[¶](#consider-using-a-third-party-service)
...
### One-Time Password Tokens[¶](#one-time-password-tokens)
...
#### Software OTP Tokens[¶](#software-otp-tokens)
...
### Universal Second Factor[¶](#universal-second-factor)
...
> [!WARNING] NIST SP 800-63B-4 designates SMS and PSTN-delivered codes as a
>
> *restricted*authenticator because of SS7 interception, SIM-swap, and number-porting attacks. Do not use SMS for high-value or PII-handling applications. Where it is the only available factor, document the risk acceptance, enforce per-account rate limits, monitor for SIM-swap signals, and plan migration to TOTP, push notifications, or WebAuthn/FIDO2.
...
### Keystroke & Mouse Dynamics[¶](#keystroke-mouse-dynamics)
