...
- cryptographic
- data
date_collected: '2026-07-26T12:36:35.397203Z'
language: unknown
---

# Key Management Cheat Sheet[¶](#key-management-cheat-sheet)
...
## General Guidelines and Considerations[¶](#general-guidelines-and-considerations)
...
, many algorithms and schemes that provide a security service use a [hash function](https://en.wikipedia.org/wiki/Hash_function) as a component of the algorithm.
...
#### Key Encryption Keys[¶](#key-encryption-keys)
...
- When moving to [Elliptic Curve-based algorithms](https://en.wikipedia.org/wiki/Elliptic-curve_cryptography), choose a key length that meets or exceeds the comparative strength of other algorithms in use within your system. Refer to
  ```
...
[Ephemeral keys](https://en.wikipedia.org/wiki/Ephemeral_key) can provide perfect forward secrecy protection, which means a compromise of the server's long term signing key does not compromise the confidentiality of past sessions. Refer to [TLS cheat sheet](Transport_Layer_Security_Cheat_Sheet.html).
...
### Cryptographic Module Topics[¶](#cryptographic-module-topics)
...
## Key Management Lifecycle Best Practices[¶](#key-management-lifecycle-best-practices)
...
For a more complete guide to storing sensitive information such as keys, see the [Secrets Management Cheat Sheet](Secrets_Management_Cheat_Sheet.html).

### Escrow and Backup[¶](#escrow-and-backup)
...
### Accountability and Audit[¶](#accountability-and-audit)
...
### Key Compromise and Recovery[¶](#key-compromise-and-recovery)
...
## Cryptographic Key Management Libraries[¶](#cryptographic-key-management-libraries)
