...
title: Einführung
source: owasp.org
url: https://owasp.org/Top10/2021/de/A00_2021_Introduction/
collector: owasp
...
- der
- wir
date_collected: '2026-07-25T14:26:24.759206Z'
language: unknown
---
...
- steigt von der[A01:2021-Mangelhafte Zugriffskontrolle](../A01_2021-Broken_Access_Control/)[fünften Position](https://owasp.org/www-project-top-ten/2017/A5_2017-Broken_Access_Control)in die Kategorie mit dem schwerwiegendsten Sicherheitsrisiko für Webanwendungen auf. Die uns zur Verfügung gestellten Daten zeigen, dass im Durchschnitt 3,81% der getesteten Anwendungen eine oder mehrere Common Weakness Enumerations (CWEs) dieser Kategorie aufweisen. Insgesamt wurden mehr als 318.000 CWEs in dieser Risikokategorie genannt. Die 34 CWE-Typen, die wir der 'mangelhaften Zugriffskontrolle' zuordneten, traten in Anwendungen häufiger auf, als die jeder anderen Kategorie.
- steigt mit neuem Namen um eine Position auf Nummer 2 auf. Bisher hieß diese Kategorie[A02:2021-Fehlerhafter Einsatz von Kryptographie](../A02_2021-Cryptographic_Failures/), was eher ein (allgemeines) Symptom, als die Grundursache war. Der neue Name fokussiert auf Fehler im Zusammenhang mit der Kryptographie, wie dies bereits implizit der Fall war. Diese Kategorie führt häufig zur Offenlegung vertraulicher Daten oder zur Kompromittierung des Systems.[A3:2017-Sensitive Data Exposure](https://owasp.org/www-project-top-ten/2017/A3_2017-Sensitive_Data_Exposure)
- [A03:2021-Injection](../A03_2021-Injection/)[steigt von der ersten](https://owasp.org/www-project-top-ten/2017/A1_2017-Injection)auf die dritte Position ab. 94% der Anwendungen wurden auf eine Art von 'Injection' getestet, mit einer maximalen Inzidenzrate von 19% und einer durchschnittlichen Rate von 3,37%. Die 33 CWE-Typen dieser Kategorie weisen mit einem Vorkommen von insgesamt 274.000 Nennungen die zweithäufigsten Vorfälle bei Webanwendungen auf. 'Cross-Site Scripting' (XSS) wurde in dieser Ausgabe der Top 10 nun Teil dieser Kategorie.
- ist eine neue Kategorie dieser Ausgabe, die sich mit Risiken im Zusammenhang mit Designfehlern bei Anwendungen beschäftigt. Um die IT-Sicherheit früher im Software-Entwicklungsprozess zu berücksichtigen, brauchen wir mehr Bedrohungsmodellierung, sichere Entwurfsmuster und -prinzipien sowie Referenzarchitekturen. Ein unsicheres Design kann nicht durch eine perfekte Implementierung behoben werden, da die erforderlichen Sicherheitsmaßnahmen definitionsgemäß nie zur Abwehr bestimmter Angriffe berücksichtigt und implementiert wurden.[A04:2021-Unsicheres Anwendungsdesign](../A04_2021-Insecure_Design/)
- wechselt von[A05:2021-Sicherheitsrelevante Fehlkonfiguration](../A05_2021-Security_Misconfiguration/)[Position 6 in der vorherigen Ausgabe](https://owasp.org/www-project-top-ten/2017/A6_2017-Security_Misconfiguration)einen Platz nach oben. 90% der Anwendungen wurden auf irgendeine Art von Fehlkonfiguration getestet, mit einer durchschnittlichen Inzidenzrate von 4,5% und über 208.000 CWEs, die dieser Risikokategorie zugeordnet wurden. Angesichts der zunehmenden Verlagerung zu hoch konfigurierbarer Software, ist es nicht verwunderlich, dass diese Kategorie aufsteigt. Die frühere Kategorie fürist jetzt auch Teil dieses Riikos.[A4:2017-XML External Entities (XXE)](https://owasp.org/www-project-top-ten/2017/A4_2017-XML_External_Entities_(XXE))
- trug zuvor den Titel "[A06:2021-Unsichere oder veraltete Komponenten](../A06_2021-Vulnerable_and_Outdated_Components/)[A9:2017-Using Components with Known Vulnerabilities](https://owasp.org/www-project-top-ten/2017/A9_2017-Using_Components_with_Known_Vulnerabilities)" und ist Nr. 2 in der Top-10-Community-Umfrage, verfügte jedoch über genügend Nennungen in den gespendeten Daten, um es bereits darüber in die Top 10 zu schaffen. Diese Kategorie steigt von[Position 9 im Jahr 2017](https://owasp.org/www-project-top-ten/2017/A9_2017-Using_Components_with_Known_Vulnerabilities)auf Position 6 auf. Es handelt sich hierbei um ein bekanntes Problem, dessen Risiko wir nur schwer testen und bewerten können. Es ist die einzige Kategorie, bei der die zugeordneten CWEs von keiner 'Common Vulnerability and Exposure' (CVE) referenziert wird, sodass in ihren Bewertungen ein mittlerer Standard-Score von 5,0 für Exploit und in der Auswirkung berücksichtigt werden.
- fällt von der[A07:2021-Fehlerhafte Authentifizierung](../A07_2021-Identification_and_Authentication_Failures/)[zweiten Position](https://owasp.org/www-project-top-ten/2017/A2_2017-Broken_Authentication)auf Platz 7 zurück. Das Risiko enthält jetzt CWEs, die eher mit Identifikationsfehlern zusammenhängen. Diese Kategorie ist immer noch ein fester Bestandteil der Top 10, aber die zunehmende Verfügbarkeit standardisierter Frameworks scheint hier zu helfen.
- ist eine weitere, neue Kategorie für die Ausgabe von 2021, die sich auf Annahmen im Zusammenhang mit Software-Updates, kritischen Daten und CI/CD-Pipelines ohne Überprüfung der Integrität befasst. Die 10 CWE-Typen dieser Kategorie werden von 'Common Vulnerability and Exposures' (CVEs) mit den höchsten 'Common Vulnerability Scoring System' (CVSS)-Scores referenziert.[A08:2021-Fehlerhafte Prüfung der Software- und Datenintegrität](../A08_2021-Software_and_Data_Integrity_Failures/)ist jetzt ein Teil dieser umfangreicher gewordenen Kategorie.[A8:2017-Security Misconfiguration](https://owasp.org/www-project-top-ten/2017/A8_2017-Insecure_Deserialization)
- hieß früher[A09:2021-Unzureichendes Logging und Sicherheitsmonitoring](../A09_2021-Security_Logging_and_Monitoring_Failures/), wurde auf Basis der Top-10-Community-Umfrage (Nr. 3) hinzugefügt und rückt von Platz 10 auf. Diese Kategorie wurde erweitert, um mehr Fehlertypen abzudecken, ist schwierig zu testen und ist in den CVE/CVSS-Daten nicht gut vertreten. Fehler in dieser Kategorie können sich jedoch direkt auf die Sichtbarkeit, Alarmierung bei Vorfällen und Forensik der Anwendung auswirken.[A10:2017-Insufficient Logging&Monitoring](https://owasp.org/www-project-top-ten/2017/A10_2017-Insufficient_Logging%2526Monitoring)
- wurde aus der Top-10-Community-Umfrage (Nr. 1) hinzugefügt. Die Daten zeigen eine relativ niedrige Inzidenzrate bei einer überdurchschnittlichen Testabdeckung sowie überdurchschnittlichen Bewertungen für Exploit- und Impact-Potenzial. Diese Kategorie entspricht dem Szenario, bei dem die Mitglieder der Sicherheits-Community uns mitteilen, dass dies wichtig ist, auch wenn es in den Daten zu diesem Zeitpunkt nicht abgebildet wird.[A10:2021-Server-Side Request Forgery](../A10_2021-Server-Side_Request_Forgery_%28SSRF%29/)
...
In dieser Version gibt es durchschnittlich 19,6 CWE-Typen pro Top10-Kategorie, wobei das Minimum bei 1 CWE für  [A10:2021-Server-Side Request Forgery](../A10_2021-Server-Side_Request_Forgery_%28SSRF%29/) und das Maximum bei 40 CWEs in

[liegt. Diese aktualisierte Kategoriestruktur bietet zusätzliche Vorteile bei Schulungen, da sich Unternehmen jeweils auf die CWEs konzentrieren können, die für eine Programmiersprache/ein Framework besonders sinnvoll erscheinen.](../A04_2021-Insecure_Design/)
