...
- pipeline
- secrets
date_collected: '2026-07-26T12:36:15.748020Z'
language: unknown
---

# CI/CD Security Cheat Sheet[¶](#cicd-security-cheat-sheet)
...
### Understanding CI/CD Risk[¶](#understanding-cicd-risk)
...
### Secure SCM Configuration[¶](#secure-scm-configuration)
...
### Pipeline and Execution Environment[¶](#pipeline-and-execution-environment)
...
- If pipelines steps are executed in Docker image, avoid using the
  ...
  flag[ref](https://research.nccgroup.com/2022/01/13/10-real-world-stories-of-how-weve-compromised-ci-cd-pipelines/)
...
## Managing Third-Party Code[¶](#managing-third-party-code)
...
### Plug-In and Integration Management[¶](#plug-in-and-integration-management)
