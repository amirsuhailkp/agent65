...
- file
- 'off'
date_collected: '2026-07-26T12:36:47.126861Z'
language: unknown
---

# PHP Configuration Cheat Sheet[¶](#php-configuration-cheat-sheet)
...
## PHP Configuration and Deployment[¶](#php-configuration-and-deployment)
...
#### PHP general settings[¶](#php-general-settings)
```
```
...
prevents [LFI](https://www.acunetix.com/blog/articles/local-file-inclusion-lfi/)s to be easily escalated to [RFI](https://www.acunetix.com/blog/articles/remote-file-inclusion-rfi/)s.

#### PHP file upload handling[¶](#php-file-upload-handling)
```
```
file_uploads            = On
...
#### PHP executable handling[¶](#php-executable-handling)
```
```
enable_dl               = Off
...
#### PHP session handling[¶](#php-session-handling)
...
#### Some more security paranoid checks[¶](#some-more-security-paranoid-checks)
```
```
